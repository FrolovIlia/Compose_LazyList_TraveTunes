package io.travel_tunes.utils.map.view
...
abstract class MapView : FrameLayout {
    ...
    private fun initAttributes(context: Context, attrs: AttributeSet) {
        ...
        mapType = MapType.entries.toTypedArray()[attributeInfo.getInt(
    ...
    abstract fun getMapAsync(function: (SomeMapInterface) -> Unit)
}